...
<template>
  <article class="bg-zinc-900 border border-zinc-800 rounded-2xl overflow-hidden hover:border-zinc-700 transition-all duration-300 group flex flex-col">
    ...
    <div class="p-5 flex flex-col grow">
      <h3 class="text-lg font-bold text-zinc-100 mb-3 line-clamp-1" :title="title">
        {{ title }}
      </h3>
      ...
      <div class="flex flex-wrap gap-1.5 mb-5">
        <span 
          ...
          :key="tech"
          class="px-2 py-0.5 bg-zinc-800/50 text-zinc-400 text-[11px] font-semibold rounded-md border border-zinc-700/50"
        >
          {{ tech }}
        </span>
      </div>
